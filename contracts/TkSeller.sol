...
contract TkSeller is ITkSeller {
    ...
    struct Preventa {
        ...
        mapping(address => Compra[]) salelist; //Información sobre las compras de la preventa. El mapa es (comprador -> Array de Compra, ya que cada usuario puede comprar varias veces)
    }
